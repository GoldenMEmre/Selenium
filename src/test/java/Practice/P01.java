...
//Create a new class with main method
    public static void main(String[] args) throws InterruptedException {
        ...
        // Set Path
        WebDriverManager.chromedriver().setup();//Bu satırda driver'ımızı tanıttık ve yolunu gösterdik
       ...
       // Open google home page https://www.google.com
        ...
        //Close/quit the browser
        driver.quit();//Close son açık sayafayı kapatır. quit ise tüm sayfaları kapatır.
