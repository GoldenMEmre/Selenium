...
public class C03_DriverManageMethodlari {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Fullscreen boyut: " +driver.manage().window().getSize());//(1280, 720)-çözünürlük-
        ...
        System.out.println("istedigimiz boyut : " +driver.manage().window().getSize());//(515, 500)
